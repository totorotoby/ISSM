...
function generateExpBoundary(varargin)
    ...
    if nargin ~= 5
        error("Usage: generate_boundary(filename, expfile_out, ocean_km_buffer, boundary_resolution, plot_flag)" + newline + ...
              "    filename - name of netcdf file with masks" + newline + ...
